...
print(
    "Scoring dict with threshold of {}, lower than threshold {}, higher than threshold {}".format(threshold, lowervalue,
                                                                                                  highervalue))
...
for i in range(len(testjpg)):
    ...
    hor = math.sqrt(
        math.pow(float(testfile[0]) - float(libfile[0]), 2) + math.pow(float(testfile[1]) - float(libfile[1]),
                                                                       2)) / RAD;
